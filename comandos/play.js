...
exports.run = (client,message,args)=>{
    ...
    if(!voiceChannel)return message.channel.send(`<:alert:696822589208920124> **»** Kon'nichiwa **${message.author.username}**, para que eu toque uns beat, entre em um canal de voz.`)
    if(!conteudo.length)return message.channel.send(`<:alert:696822589208920124> **»** Kon'nichiwa **${message.author.username}**, escreva o nome da música que deseja ouvir.`)

var sla = `<:pepeMusic:691017094237782066> **»** Tocando a música no canal: \`${voiceChannel.name}\``
...
tocar()
    ...
    message.channel.send(`<a:nop:698221501668655124> **»** Kon'nichiwa **${message.author.username}**, não achei nada sobre \`${conteudo}\``)
    return;
...
tocar()
            ...
            message.channel.send(`<a:nop:698221501668655124> **»** Kon'nichiwa **${message.author.username}**, você não escolheu nenhuma opção em 30 segundos.`)
        })
    })
}
