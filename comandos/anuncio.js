...
exports.run = (client, message, args) => {
    ...
    if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<:alert:696822589208920124> **»** Kon'nichiwa **${message.author.username}-chan**, você precisa da permissão \`ADMINISTRATOR\`.`)
